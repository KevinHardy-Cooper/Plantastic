...
// This component contains labels representing the image sent to the Google Cloud Vision API
export default class Labels extends React.Component {
  ...
  getFiles(files){
    ...
    var str = this.state.files[0].base64;
  ...
  componentDidMount() {
    ...
    fetch('https://vision.googleapis.com/v1/images:annotate?key=AIzaSyClutKfqGZSGO6EvF2Du2pjcH5yfVGsxhY', {
	    method: "POST",
	      headers: {
    ...
    // We just want to check if the post was ok
        if(response.ok){
          response.json().then(json => {
			this.setState({labels:json.responses[0].labelAnnotations});          
			});
        }
      })
  ...
  render(){
  	...
  	// We only want to render to the DOM if labels are returned 
    if (this.state.labels.length != 0) {

    	return (
    		<div>
    			{this.state.labels[0].description}
